...
namespace TwentyTwenty.Mvc.ErrorHandling
{
    public class ProblemDetailsOptions
    {
        ...
        /// </summary>
        public Func<HttpContext, ProblemDetails> MapStatusCode { get; set; } = null!;
        ...
        /// </summary>
        public Func<HttpContext, Exception, ProblemDetails, bool> ShouldLogUnhandledException { get; set; } = null!;
        ...
        {
            public ExceptionMapper(Type type, Func<HttpContext, Exception, ProblemDetails?> mapping, Func<HttpContext, Exception, bool> predicate)
            {
