...
namespace TwentyTwenty.Mvc.ErrorHandling
{
    ...
    {
        public static ProblemDetails WithExceptionDetails(this ProblemDetails problem, string propertyName, Exception error, IEnumerable<ExceptionDetails> details)
        {
